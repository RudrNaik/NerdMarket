...
public class DoNotUse {
    ...
    public void testSecondActivity() {
        ...
        // check if the text in the second activity matches what you expected
        onView(withId(R.id.testTv)).check(matches(withText("This is for testing")));
    }
}
